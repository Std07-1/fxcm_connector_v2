...
$prefix = "p61_${NS}_${ReqId}_$(Get-Date -Format 'yyyyMMdd_HHmmss')"
...
if ($pyExit -ne 0) {
  Write-Error "Exit Gate P6.1 FAIL: python exit code $pyExit"
